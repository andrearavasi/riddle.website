...
export default async function Page() {
    ...
    <div>
        ...
        <ul>
            ...
            <li>
                <p><strong>Website</strong> refers to riddle.website, accessible from <a href="https://riddle.website" rel="external nofollow noopener" target="_blank">https://riddle.website</a></p>
            </li>
            <li>
